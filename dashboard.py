...
const chart=new Chart(document.getElementById('historyChart'),{type:'line',data:{labels:[],datasets:[{label:'Free heap (KB)',data:[],borderColor:'#70f0d0',yAxisID:'heap'},{label:'Wi-Fi (dBm)',data:[],borderColor:'#ffc857',yAxisID:'rssi'}]},options:{animation:false}});
