...
<body><header><div><h1>M5 Device Telemetry</h1><div class='sub'>Live health monitor for your edge device</div></div></header><div id='dashboard'>{content}</div><footer>Live via WebSocket · MQTT: devices/+/health</footer><script>
